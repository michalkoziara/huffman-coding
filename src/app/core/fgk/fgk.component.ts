...
@Component({
  selector: 'app-fgk',
  templateUrl: './fgk.component.html',
  styleUrls: ['./fgk.component.scss']
})
export class FgkComponent {
  formGroup: FormGroup;
  ...
  submit(): void {
    if (this.formGroup) {
      ...
      this.huffmanTree = this.huffmanService.createFgkHuffmanTree(this.formGroup.get('inputText')?.value);
